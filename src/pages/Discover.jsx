...
import { Compass, Filter as FilterIcon } from "lucide-react";
...
export default function Discover() {
  ...
  // Draft filters (editing in sheet)
          ...
          {isLoading ? (
            ...
            <Card className="p-4 border-slate-200">
              ...
              <div className="mt-4 flex gap-2">
                ...
                <Button variant="outline" onClick={() => setFilterOpen(true)} className="flex-1">
                  Edit filters
                </Button>
              </div>
            </Card>
