...
function normalizeSiteRow(r) {
  return {
    ...
    needs_review: typeof (r && r.needs_review) === "boolean" ? r.needs_review : !!(r && r.needs_review),
...
async function normalizeCampDatesToISO() {
  ...
  function isBadLogoValue(v) {
    ...
    if (t === "na" || t === "n/a" || t === "none" || t === "null" || t === "undefined" || t === "0") return true;

    const isHttp = t.startsWith("http://") || t.startsWith("https://");
