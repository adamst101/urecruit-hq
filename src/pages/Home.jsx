...
export default function Home() {
  ...
  // Copy (shorter bullets = more professional)
      ...
      <div className="max-w-5xl mx-auto px-6 py-10 space-y-8">
        ...
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="text-2xl font-extrabold text-deep-navy">RecruitMe</div>
        ...
        {/* HERO (single module — no extra boxes) */}
        <Card className="bg-white border-0 shadow-md rounded-2xl">
          <div className="p-8 md:p-10 space-y-6">
            {/* Copy block */}
            <div className="max-w-3xl space-y-3">
              <h1 className="text-3xl md:text-4xl font-extrabold text-deep-navy leading-tight">
                {heroHeadline}
              </h1>
                ...
                <div key={x.a} className="rounded-xl bg-slate-50 border border-slate-200 p-4">
                  <div className="flex items-start gap-2">
                    ...
                    <div className="text-sm">
                      <div className="font-bold text-deep-navy">{x.a}</div>
            ...
            {/* How it works strip (incorporated here, per your ask) */}
            <div className="rounded-xl border border-slate-200 bg-white p-4">
              <div className="grid md:grid-cols-3 gap-4">
                {howStrip.map((x) => (
                  <div key={x.title} className="text-sm">
                    <div className="font-bold text-deep-navy">{x.title}</div>
            ...
            {/* CTA cluster (your requested order) */}
