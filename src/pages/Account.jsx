...
function LinkRow({ label, sub, onClick, borderTop }) {
  return (
    <button
      onClick={onClick}
      style={{ width: "100%", padding: "14px 16px", borderTop: borderTop ? "1px solid #1f2937" : "none", background: "none", border: "none", display: "flex", alignItems: "center", justifyContent: "space-between", cursor: "pointer", textAlign: "left" }}
    >
      <div>
